(function() {
  ...
  updateCartDialog: function() {
    ...
    $cart_contents
      .html("")
      .append("\
      <table id='cart_summary' tabindex='0'>\
    ...
    if (app.elements.cart_count > 0) {
      ...
      $.each(data.products, function(index, element) {
        ...
        if ($.inArray(element.pid, keys) > -1) {
          ...
          <tr id='row_" + index + "'>\
          <td><img tabindex='0' class='product_thumb' src='" + element.img_uri  + "' alt='" + item_title  + " thumbnail'></td> \
          <td tabindex='0' aria-label='" + item_title + "' class='product_title'>" + item_title + "</td>\
          <td tabindex='0' aria-label='" + element.price + "' class='product_price'>$" + element.price + "</td>\
          <td tabindex='0' id='product_quantity_" + index  + "' aria-label='Item quantity: " + item_quantity + "' class='product_quantity'>" + item_quantity + "</td>\
  ...
  removeModal: function() {
    var $selected = $("[role=menuitem][aria-selected=true]");
  ...
  bindings: function() {
    ...
    $("#product_sections > [role=menuitem]").on("click", function() {
      $(this)
      .siblings()
    ...
    $(document.documentElement).keyup(function (event) {
      var UP          = 38,
          ...
          direction   = null,
          key_pressed = event.keyCode,
          $navigable  = $("[role=menuitem]"),
          $selected   = $("[role=menuitem][aria-selected=true]");
